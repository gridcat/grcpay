...
use Grcpay\Helper;
use Grcpay\GrcpayTransportException;

class WC_Grcpay_Gateway extends WC_Payment_Gateway
{
    ...
    // Settings fields populated by grcpay_settings()
    private $api_url;
    ...
    function __construct()
    {
        ...
        $this->method_description = __('Accept Gridcoin (GRC) payments via grc-payment-proxy', 'grcpay-woocommerce');

        $this->supports = ['products'];

        $this->init_form_fields();
        $this->init_settings();
        $this->grcpay_settings();
        ...
        // AJAX status polling is dispatched at the top level in grcpay-woocommerce.php
    ...
    private function grcpay_settings()
    {
    ...
    function init_form_fields()
    {
        $this->form_fields = [
            'enabled' => [
                'title' => __('Enabled', 'grcpay-woocommerce'),
                'type' => 'checkbox',
                'label' => __('Enable Gridcoin Payments', 'grcpay-woocommerce'),
                'default' => 'yes',
            ],
            'title' => [
                'title' => __('Title', 'grcpay-woocommerce'),
                'type' => 'text',
                'description' => __('Title shown during checkout.', 'grcpay-woocommerce'),
                'default' => __('Gridcoin (GRC)', 'grcpay-woocommerce'),
                'desc_tip' => true,
            ],
            'description' => [
                'title' => __('Description', 'grcpay-woocommerce'),
                'type' => 'textarea',
                'default' => __('Pay with Gridcoin cryptocurrency.', 'grcpay-woocommerce'),
                'description' => __('Description shown during checkout.', 'grcpay-woocommerce'),
            ],
            'api_url' => [
                'title' => __('Payment Proxy URL', 'grcpay-woocommerce'),
                'type' => 'text',
                'description' => __('URL of the grc-payment-proxy API. Use <code>https://grcpay.gridcoin.club</code> for the public test instance, or your own deployment (e.g. <code>http://grcpay:7001</code> for Docker).', 'grcpay-woocommerce'),
                'default' => 'https://grcpay.gridcoin.club',
            ],
            'api_url_backup' => [
                'title' => __('Backup Payment Proxy URL', 'grcpay-woocommerce'),
                'type' => 'text',
                'description' => __('Optional fallback URL. Used <strong>only</strong> when the primary URL is unreachable at wallet-creation time. Each order is pinned at creation to the server that minted its wallet, so orders already created on the primary cannot be moved — the backup only helps new checkouts ride through a primary outage. Leave blank to disable fallback.', 'grcpay-woocommerce'),
                'default' => '',
            ],
            'grc_address' => [
                'title' => __('Gridcoin Address', 'grcpay-woocommerce'),
                'type' => 'text',
                'description' => __('Your Gridcoin address where payments will be forwarded.', 'grcpay-woocommerce'),
                'desc_tip' => true,
            ],
            'show_branding' => [
                'title' => __('Show Gridcoin branding', 'grcpay-woocommerce'),
                'type' => 'checkbox',
                'label' => __('Show Gridcoin logo on the payment page', 'grcpay-woocommerce'),
                'default' => 'yes',
            ],
            'qrcode_default' => [
                'title' => __('QR Code by default', 'grcpay-woocommerce'),
                'type' => 'checkbox',
                'label' => __('Show the QR Code by default on the thank you page', 'grcpay-woocommerce'),
                'default' => 'yes',
            ],
            'qrcode_size' => [
                'title' => __('QR Code size', 'grcpay-woocommerce'),
                'type' => 'number',
                'default' => 300,
                'description' => __('QR code image size in pixels.', 'grcpay-woocommerce'),
            ],
            'color_scheme' => [
                'title' => __('Color Scheme', 'grcpay-woocommerce'),
                'type' => 'select',
                'default' => 'light',
                'description' => __('Color scheme for the payment UI.', 'grcpay-woocommerce'),
                'options' => [
                    'light' => __('Light', 'grcpay-woocommerce'),
                    'dark' => __('Dark', 'grcpay-woocommerce'),
                    'auto' => __('Auto', 'grcpay-woocommerce'),
                ],
            ],
            'order_cancelation_timeout' => [
                'title' => __('Order cancellation timeout', 'grcpay-woocommerce'),
                'type' => 'select',
                'default' => '0',
                'options' => [
                    '0' => __('Never', 'grcpay-woocommerce'),
                    '3600' => __('1 Hour', 'grcpay-woocommerce'),
                    '21600' => __('6 Hours', 'grcpay-woocommerce'),
                    '43200' => __('12 Hours', 'grcpay-woocommerce'),
                    '86400' => __('24 Hours', 'grcpay-woocommerce'),
                ],
                'description' => __('Cancel unpaid orders after this period.', 'grcpay-woocommerce'),
            ],
            'virtual_complete' => [
                'title' => __('Auto-complete virtual orders', 'grcpay-woocommerce'),
                'type' => 'checkbox',
                'label' => __('Mark orders with only virtual products as "completed" when payment is received.', 'grcpay-woocommerce'),
                'default' => 'no',
            ],
            'disable_conversion' => [
                'title' => __('Disable price conversion', 'grcpay-woocommerce'),
                'type' => 'checkbox',
                'label' => __('If checked, customers pay the exact shop price in GRC (no fiat-to-GRC conversion).', 'grcpay-woocommerce'),
                'default' => 'no',
            ],
            'use_proxy_rates' => [
                'title' => __('Use proxy for exchange rates', 'grcpay-woocommerce'),
                'type' => 'checkbox',
                'label' => __('Fetch GRC exchange rates from the payment proxy instead of CoinGecko directly. Recommended for production (avoids CoinGecko rate limits).', 'grcpay-woocommerce'),
                'default' => 'yes',
            ],
        ];
    }
    ...
    public function get_icon()
    {
        ...
        // Inline style so the logo doesn't need grcpay.css (which only
    ...
    function process_payment($order_id)
    {
        ...
        try {
            ...
            if ($crypto_total < $min_tx) {
                wc_add_notice(
                    __('Payment error:', 'grcpay-woocommerce') . ' ' .
                    __('Value too low, minimum is', 'grcpay-woocommerce') . ' ' . $min_tx . ' GRC',
                    'error'
                );
                return null;
            }
            ...
            foreach ($candidate_urls as $check_url) {
                if ($this->is_insecure_api_url($check_url)) {
                    wc_add_notice(
                        __('Payment error:', 'grcpay-woocommerce') . ' ' . sprintf(
                            // translators: %s is the configured backend URL.
                            __('The configured grcpay backend %s uses plaintext HTTP, which would leak your wallet credentials. Switch to HTTPS in the payment gateway settings before accepting real payments.', 'grcpay-woocommerce'),
                            esc_html($check_url)
                        ),
                        'error'
                    );
            ...
            if (empty($address)) {
                wc_add_notice(__('Payment error:', 'grcpay-woocommerce') . ' ' . __('Failed to generate payment address. Please try again.', 'grcpay-woocommerce'), 'error');
                return null;
            }
            ...
            if ($pinned_url !== $this->api_url) {
                $order->add_order_note(sprintf(
                    ...
                    __('Primary grcpay backend was unreachable at checkout; order was minted against the fallback backend %s. Status polling will remain pinned to the fallback for the life of this order.', 'grcpay-woocommerce'),
                    $pinned_url
                ));
            }

            $order->update_status('on-hold', __('Awaiting Gridcoin payment', 'grcpay-woocommerce'));
            $woocommerce->cart->empty_cart();
            ...
            wc_add_notice(__('Payment error:', 'grcpay-woocommerce') . ' ' . $e->getMessage(), 'error');
            return null;
        }
    }
    ...
    function order_status()
    {
        ...
        try {
            ...
            $refund_tx = Helper::sanitizeTxid($wallet ? ($wallet->attributes->refundTx ?? '') : '');
            ...
            if (!$is_paid && !$cancelled && intval($this->order_cancelation_timeout) > 0) {
                ...
                if ((time() - $created) > intval($this->order_cancelation_timeout)) {
                    if ($order->get_status() !== 'cancelled') {
                        $order->update_status('cancelled', __('Order cancelled: payment timeout.', 'grcpay-woocommerce'));
                    }
                    $cancelled = true;
                }
            }
            ...
            // Refuse anything that isn't a `data:image/...` payload. The
            // value originated at grcpay; constraining it here means
            // payment.js never even sees a `javascript:` or remote URL
            // even if a proxy is malicious or buggy.
            if (!is_string($qr_code_value) || strpos($qr_code_value, 'data:image/') !== 0) {
                $qr_code_value = '';
            }
    ...
    function on_order_cancelled($order_id)
    {
        ...
        $order->add_order_note(
            $ok
                ? __('Gridcoin wallet cancelled at grcpay — refund flow queued.', 'grcpay-woocommerce')
                : __('Failed to cancel the Gridcoin wallet at grcpay — the refund flow will still trigger when the wallet expires naturally.', 'grcpay-woocommerce')
        );
    }
    ...
    function check_pending_orders()
    {
        ...
        $context = __('(detected via background check)', 'grcpay-woocommerce');
    ...
    public function admin_options()
    {
        ...
        foreach (['api_url', 'api_url_backup'] as $field) {
            ...
            if ($this->is_insecure_api_url($candidate)) {
                $warnings[] = sprintf(
                    ...
                    __('%1$s is set to <code>%2$s</code>, which uses plaintext HTTP. Wallet tokens would be sent in the clear on every polling tick and any network observer could read or cancel orders. Switch to HTTPS before accepting real payments.', 'grcpay-woocommerce'),
                    esc_html($field === 'api_url' ? __('Payment Proxy URL', 'grcpay-woocommerce') : __('Backup Payment Proxy URL', 'grcpay-woocommerce')),
                    esc_html($candidate)
                );
            }
        }
        if (!empty($warnings)) {
            ...
            echo '<p><strong>' . esc_html__('Gridcoin Payment Gateway — security warning', 'grcpay-woocommerce') . '</strong></p>';
        ...
        switch ($proxy_status) {
            ...
            case 'processed':
                if (!$flags['is_paid']) {
                    ...
                    $order->add_order_note(
                        __('Gridcoin payment confirmed.', 'grcpay-woocommerce') . $suffix
            ...
            case 'norefund':
                if ($order->get_status() !== 'cancelled') {
                    $order->update_status(
                        'cancelled',
                        __('Gridcoin payment window elapsed without a sufficient payment. Wallet has been expired at grcpay.', 'grcpay-woocommerce') . $suffix
                    );
                    $order->save();
                }
            ...
            case 'refunded':
                if ($order->get_status() !== 'cancelled') {
                    $note = __('Gridcoin payment window elapsed with a partial balance.', 'grcpay-woocommerce') . $suffix;
                    ...
                    if ($refund_amount_grc > 0) {
                        $note .= ' ' . sprintf(
                            ...
                            __('grcpay refunded %1$s GRC to the original sender (tx %2$s).', 'grcpay-woocommerce'),
                            Helper::sig_fig($refund_amount_grc, 6),
                            Helper::sanitizeTxid($wallet->attributes->refundTx ?? '')
                        );
                    }
            ...
            case 'error':
                ...
                if (!$order->get_meta('grcpay_error_noted')) {
                    $order->add_order_note(
                        __('grcpay wallet entered error state — please inspect. The WC order is left on-hold so an operator can decide whether to complete or cancel manually.', 'grcpay-woocommerce') . $suffix
                    );
    ...
    function thankyou_page($order_id)
    {
        ...
        // GRCPAY_PLUGIN_VERSION query string and a user who loaded the
        ...
        $js_path = GRCPAY_PLUGIN_PATH . 'static/payment.js';
        $css_path = GRCPAY_PLUGIN_PATH . 'static/grcpay.css';
        $js_ver = file_exists($js_path) ? filemtime($js_path) : GRCPAY_PLUGIN_VERSION;
        $css_ver = file_exists($css_path) ? filemtime($css_path) : GRCPAY_PLUGIN_VERSION;

        wp_enqueue_script('grcpay-payment', GRCPAY_PLUGIN_URL . 'static/payment.js', ['jquery'], $js_ver, true);
        ...
        // `?action=grcpay_order_status&amp;order_id=22` — PHP then parsed
        ...
        wp_add_inline_script('grcpay-payment', "jQuery(function() { var ajax_url = " . wp_json_encode($ajax_url) . "; setTimeout(function(){ check_status(ajax_url) }, 500) })");
        wp_enqueue_style('grcpay-loader-css', GRCPAY_PLUGIN_URL . 'static/grcpay.css', false, $css_ver);

        $cancel_timer = $order->get_date_created()->getTimestamp() + (int)$this->order_cancelation_timeout - time();

        ?>
        <div class="grcpay_payment_panel <?php
            if ($color_scheme === 'auto') echo 'auto';
            elseif ($color_scheme === 'dark') echo 'dark';
            else echo 'light';
        ?>">
            <div class="grcpay_payment_details">
                <?php if ($total > 0) { ?>
                    <div class="grcpay_payments_wrapper">
                        <div class="grcpay_qrcode_wrapper" style="<?php echo $this->qrcode_default ? 'display:block' : 'display:none'; ?>; width: <?php echo intval($this->qrcode_size) + 20; ?>px;">
                            <div class="inner-wrapper">
                                <figure>
                                    <?php if ($qr_code_img) { ?>
                                        <img class="grcpay_qrcode" width="<?php echo intval($this->qrcode_size); ?>" src="<?php echo esc_attr($qr_code_img); ?>" alt="<?php echo esc_attr__('QR Code', 'grcpay-woocommerce'); ?>" />
                                    <?php } ?>
                                </figure>
                            </div>
                        </div>
                        <div class="grcpay_details_box">
                            <div class="grcpay_details_text">
                                <?php echo esc_html__('PLEASE SEND', 'grcpay-woocommerce'); ?>
                                <button class="grcpay_copy grcpay_details_copy" data-tocopy="<?php echo esc_attr($crypto_value); ?>">
                                    <span><b class="grcpay_value"><?php echo esc_html($crypto_value); ?></b></span>
                                    <span><b><?php echo esc_html(strtoupper($crypto_coin)); ?></b></span>
                                    <span class="grcpay_tooltip grcpay_copy_icon_tooltip tip"><?php echo esc_html__('COPY', 'grcpay-woocommerce'); ?></span>
                                    <span class="grcpay_tooltip grcpay_copy_icon_tooltip success" style="display:none"><?php echo esc_html__('COPIED!', 'grcpay-woocommerce'); ?></span>
                                </button>
                                <strong>(<?php echo esc_html($currency_symbol) . ' <span class="grcpay_fiat_total">' . esc_html($total) . '</span>'; ?>)</strong>
                            </div>

                            <div class="grcpay_payment_notification grcpay_notification_payment_received" style="display:none;">
                                <?php echo sprintf(
                                    esc_html__('So far you sent %s. Please send a new payment to complete the order.', 'grcpay-woocommerce'),
                                    '<strong><span class="grcpay_notification_ammount"></span></strong>'
                                ); ?>
                            </div>

                            <div class="grcpay_payment_notification grcpay_notification_pending_confs" style="display:none;">
                                <?php echo sprintf(
                                    esc_html__('We detected %s on its way. Waiting for it to confirm on the blockchain — no action needed from you.', 'grcpay-woocommerce'),
                                    '<strong><span class="grcpay_pending_amount"></span></strong>'
                                ); ?>
                            </div>

                            <div class="grcpay_payment_notification grcpay_notification_confirming" style="display:none;">
                                <div class="grcpay_confirming_spinner" aria-hidden="true"></div>
                                <div class="grcpay_confirming_text">
                                    <strong><?php esc_html_e('Payment detected on-chain — waiting for confirmations.', 'grcpay-woocommerce'); ?></strong>
                                    <br/>
                                    <?php esc_html_e('Your full payment has arrived at the network level. We just need a few more blocks to be absolutely sure before the order is marked paid. This usually takes a couple of minutes — you can safely close this tab, the order will update itself.', 'grcpay-woocommerce'); ?>
                                </div>
                            </div>

                            <div class="grcpay_payment_notification grcpay_notification_remaining" style="display:none">
                                <strong><?php echo esc_html__('Notice', 'grcpay-woocommerce'); ?></strong>:
                                <?php echo sprintf(
                                    esc_html__('Minimum transaction is %s, value has been adjusted.', 'grcpay-woocommerce'),
                                    esc_html($min_tx . ' ' . strtoupper($crypto_coin))
                                ); ?>
                            </div>

                            <div class="grcpay_details_input">
                                <span><?php echo esc_html($address_in); ?></span>
                                <button class="grcpay_copy grcpay_copy_icon" data-tocopy="<?php echo esc_attr($address_in); ?>">
                                    <span class="grcpay_tooltip grcpay_copy_icon_tooltip tip"><?php echo esc_html__('COPY', 'grcpay-woocommerce'); ?></span>
                                    <span class="grcpay_tooltip grcpay_copy_icon_tooltip success" style="display:none"><?php echo esc_html__('COPIED!', 'grcpay-woocommerce'); ?></span>
                                </button>
                                <div class="grcpay_loader"></div>
                            </div>
                        </div>

                        <?php if (intval($this->order_cancelation_timeout) > 0) { ?>
                            <span class="grcpay_notification_cancel" data-text="<?php echo esc_attr__('Order will be cancelled in less than a minute.', 'grcpay-woocommerce'); ?>">
                                <?php echo sprintf(
                                    esc_html__('This order will be valid for %s', 'grcpay-woocommerce'),
                                    '<strong><span class="grcpay_cancel_timer" data-timestamp="' . esc_attr($cancel_timer) . '">' . esc_html(gmdate('H:i', max(0, $cancel_timer))) . '</span></strong>'
                                ); ?>
                            </span>
                        <?php } ?>

                        <div class="grcpay_buttons_container">
                            <a class="grcpay_show_qr" href="#" aria-label="<?php echo esc_attr__('Toggle QR code', 'grcpay-woocommerce'); ?>">
                                <span class="grcpay_show_qr_open<?php echo !$this->qrcode_default ? ' active' : ''; ?>"><?php echo esc_html__('Open QR CODE', 'grcpay-woocommerce'); ?></span>
                                <span class="grcpay_show_qr_close<?php echo $this->qrcode_default ? ' active' : ''; ?>"><?php echo esc_html__('Close QR CODE', 'grcpay-woocommerce'); ?></span>
                            </a>
                        </div>

                        <?php if ($this->show_branding) { ?>
                            <div class="grcpay_branding">
                                <span><?php echo esc_html__('Powered by Gridcoin', 'grcpay-woocommerce'); ?></span>
                            </div>
                        <?php } ?>
                    </div>
                <?php } ?>

                <div class="grcpay_payment_processing" style="display:none;">
                    <div class="grcpay_loader_payment_processing"></div>
                    <h2><?php echo esc_html__('Your payment is being processed!', 'grcpay-woocommerce'); ?></h2>
                    <h5><?php echo esc_html__('Processing can take some time depending on the blockchain.', 'grcpay-woocommerce'); ?></h5>
                </div>

                <div class="grcpay_payment_confirmed" style="display:none;">
                    <div class="grcpay_payment_confirmed_icon">
                    ...
                    <h2><?php echo esc_html__('Your payment has been confirmed!', 'grcpay-woocommerce'); ?></h2>
                </div>

                <div class="grcpay_payment_cancelled" style="display:none;">
                    <div class="grcpay_payment_cancelled_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="100">
                    ...
                    <h2><?php echo esc_html__('Order has been cancelled due to lack of payment.', 'grcpay-woocommerce'); ?></h2>
                </div>

                <div class="grcpay_payment_refunded" style="display:none;">
                    <div class="grcpay_payment_cancelled_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="100">
                            <path fill="#ef6c00" d="M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zm-248 50c-25.405 0-46 20.595-46 46s20.595 46 46 46 46-20.595 46-46-20.595-46-46-46zm-43.673-165.346l7.418 136c.347 6.364 5.609 11.346 11.982 11.346h48.546c6.373 0 11.635-4.982 11.982-11.346l7.418-136c.375-6.874-5.098-12.654-11.982-12.654h-63.383c-6.884 0-12.356 5.78-11.981 12.654z"/>
                        </svg>
                    </div>
                    <h2><?php echo esc_html__('Payment window elapsed — partial balance refunded.', 'grcpay-woocommerce'); ?></h2>
                    <p class="grcpay_refund_details"><?php
                        /* Filled in by payment.js from the wallet refundTx / refundAmount fields. */
                        echo esc_html__('We have returned the GRC you sent to the original sending wallet. No further action is needed from you.', 'grcpay-woocommerce');
                    ?></p>
                    <p class="grcpay_refund_tx" style="font-family:monospace;font-size:12px;word-break:break-all;"></p>
                </div>

                <div class="grcpay_payment_error" style="display:none;">
                    <div class="grcpay_payment_cancelled_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="100">
                            <path fill="#8e24aa" d="M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zm-248 50c-25.405 0-46 20.595-46 46s20.595 46 46 46 46-20.595 46-46-20.595-46-46-46zm-43.673-165.346l7.418 136c.347 6.364 5.609 11.346 11.982 11.346h48.546c6.373 0 11.635-4.982 11.982-11.346l7.418-136c.375-6.874-5.098-12.654-11.982-12.654h-63.383c-6.884 0-12.356 5.78-11.981 12.654z"/>
                        </svg>
                    </div>
                    <h2><?php echo esc_html__('Payment processing issue — we are looking into it.', 'grcpay-woocommerce'); ?></h2>
                    <p><?php echo esc_html__('Something went wrong on our end while settling your payment. Please contact support and mention your order number — we can see the full history of your wallet.', 'grcpay-woocommerce'); ?></p>
                </div>

                <?php if ($total > 0) { ?>
                    <div class="grcpay_progress">
                        <div class="grcpay_progress_icon waiting_payment done">
                            ...
                            <p><?php echo esc_html__('Waiting for payment', 'grcpay-woocommerce'); ?></p>
                        </div>
                        <div class="grcpay_progress_icon waiting_network">
                            <svg width="60" height="60" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p><?php echo esc_html__('Waiting for network confirmation', 'grcpay-woocommerce'); ?></p>
                        </div>
                        <div class="grcpay_progress_icon payment_done">
                            <svg width="60" height="60" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p><?php echo esc_html__('Payment confirmed', 'grcpay-woocommerce'); ?></p>
                        </div>
                    </div>
                <?php } ?>
            </div>
